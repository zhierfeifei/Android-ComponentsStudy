...
import com.xu.androidcomponents.Activity.BaseActivity;
import com.xu.androidcomponents.Service.GetPhoneNumberIntentService;
...
public class MainActivity extends BaseActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.intentService_btn:
              /*  Intent intentServie = new Intent(MainActivity.this,GetPhoneNumberIntentService.class);
